  ...
  return (
    <section className="py-20 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <Card className="bg-white border border-gray-200 hover:border-yellow-400 hover:shadow-xl hover:shadow-yellow-400/20 transition-all duration-300 rounded-xl">
