...
export default function TDashboard() {
  return (
    <div className="min-h-screen w-full flex">
      {/* Sidebar */}
      <div className="hidden md:block w-64 bg-[#0c1729] border-r border-gray-800 fixed h-screen">
        <TSideBar />
      </div>

      {/* Main Content */}
      <div className="flex-1 md:ml-64 bg-gradient-to-br from-[#0c1729] via-[#13233f] to-[#0c1729] min-h-screen p-4 overflow-y-auto transition-all">
        <ToastContainer
          position="bottom-right"
          autoClose={5000}
          hideProgressBar={false}
