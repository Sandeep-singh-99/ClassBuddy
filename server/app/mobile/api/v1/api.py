...
from app.mobile.api.v1.endpoints import (
    auth,
    ai_evaluator,
    assignment,
    generate_assignment,
...
app_router.include_router(
    ai_evaluator.router, prefix="/ai-evaluator", tags=["AI Evalutor"]
)
app_router.include_router(
...
app_router.include_router(
    studentInsight.router, prefix="/student-insight", tags=["Student Insight"]
)
...
app_router.include_router(
    teacherInsight.router, prefix="/insights", tags=["Teacher Insights"]
)
